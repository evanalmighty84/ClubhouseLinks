...
function validateEmailConfig(config) {
    ...
    for (const field of requiredFields) {
        if (!config[field] || !String(config[field]).trim()) {
            throw new Error(
                `paymentEmailConfig.js is missing: ${field}`
            );
        }
    }
}
...
function buildEmail(config) {
    ...
    const safePaymentUrl = escapeHtml(PAYMENT_URL);
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        ...
                                                        "
                                                    >
                                                        Activate your Clubhouse Links lead-generation service
                                                    </div>
                                                    ...
                                                    <a
                                                        ...
                                                        "
                                                    >
                                                        Click here to pay and start service
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
...
async function sendEmail() {
    try {
        ...
        console.log("ZeptoMail payment message sent:", info.messageId);
    } catch (error) {
        console.error("ZeptoMail payment message failed:", error);
        process.exitCode = 1;
    }
}
