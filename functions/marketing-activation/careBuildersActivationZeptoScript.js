...
const fs = require("fs");
const emailConfig = require("./careBuildersActivationEmailConfig");

const LOGIN_URL = "https://www.clubhouselinks.com/signin";
...
function validateEmailConfig(config) {
    ...
    for (const field of requiredFields) {
        if (!config[field] || !String(config[field]).trim()) {
            throw new Error(
                `careBuildersActivationEmailConfig.js is missing: ${field}`
            );
        }
    }
}
...
function buildEmail(config) {
    ...
    const safeTemporaryPassword = escapeHtml(config.temporaryPassword);
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;background:#ffffff;">
                    <tr>
                        <td align="center" style="padding:0;background:#ffffff;">
                            <table role="presentation" width="1100" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:1100px;background:#ffffff;border:0;">
                                <tr>
                                    <td align="center" style="padding:20px 20px 14px;background:#ffffff;">
                                        <img src="cid:clubhouse-logo" alt="Clubhouse Links" style="display:block;width:220px;max-width:75%;height:auto;border:0;">
                                    </td>
                                </tr>

                                <tr>
                                    <td align="center" style="padding:8px 20px 24px;background:#ffffff;">
                                        <table
                                            role="presentation"
                                            width="100%"
                                            cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        ...
                                                        "
                                                    >
                                                        Your Care Builders at Home account is ready
                                                    </div>
                                                    ...
                                                    <p
                                                        ...
                                                        "
                                                    >
                                                        Your payment has been received. Use the login
                                                        information below to access your Clubhouse Links
                                                        dashboard and begin reviewing opportunities.
                                                    </p>
                                                    ...
                                                    >
                                                        <tr>
                                                            <td style="padding:14px 16px 6px;font-size:14px;line-height:1.5;color:#4b5563;text-align:left;">
                                                                <strong style="color:#111827;">Username:</strong><br>
                                                                ${safeUsername}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding:6px 16px 14px;font-size:14px;line-height:1.5;color:#4b5563;text-align:left;">
                                                                <strong style="color:#111827;">Temporary password:</strong><br>
                                                                ${safeTemporaryPassword}<br>
                                                                <span style="font-size:12px;">The password is case-sensitive.</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                ...
                                <tr>
                                    <td align="center" style="padding:0 20px 22px;background:#ffffff;">
                                        <img src="cid:clubhouse-dashboard" alt="Clubhouse Links dashboard and leads screen" style="display:block;width:100%;max-width:900px;height:auto;border:0;border-radius:12px;box-shadow:0 0 22px rgba(255,59,212,0.18);">
                                    </td>
                                </tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-top:30px;border-collapse:collapse;">
                                            <tr>
                                                <td valign="top" style="padding-right:14px;">
                                                    <img src="cid:evan-headshot" alt="Evan Ligon" width="75" style="display:block;width:75px;height:75px;object-fit:cover;border-radius:50%;border:2px solid #25f4ff;box-shadow:0 0 14px rgba(37,244,255,0.28);">
                                                </td>
                                                <td valign="middle" style="font-family:Verdana,Arial,Helvetica,sans-serif;font-size:14px;line-height:1.5;color:#111827;">
                                                    <strong style="color:#111827;font-size:15px;">Evan Ligon</strong><br>
...
async function sendEmail() {
    try {
        ...
        const info = await transport.sendMail({
            ...
            attachments: [
                ...
                },
                {
                    ...
                    path: CLUBHOUSE_DASHBOARD_PATH,
                    cid: "clubhouse-dashboard",
                    contentType: "image/png",
                    contentDisposition: "inline"
                },
                {
        ...
        console.log("ZeptoMail activation message sent:", info.messageId);
    } catch (error) {
        console.error("ZeptoMail activation message failed:", error);
        process.exitCode = 1;
    }
}
