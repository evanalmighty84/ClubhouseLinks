// src/CRMtemplates/topOfMindTemplate.js

export const topOfMindTemplate = `
<div>
        ...
        <div style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10pt">
            ...
            <div class="x_827423126align-center" style="text-align: center">
                <a href="[linktoWebsite]"
                   ...
                   target="_blank">[topOfMindPitch1] </a>
            </div>
            <div>
                <br>
                <img src="[image1]" alt="Ad Image 1" width="100%">
                  [topOfMindDescription1]
                <br>
                  <br>
                <img src="[image2]" alt="Ad Image 1" width="100%">
                  [topOfMindDescription2]
                <br>
                  <br>
                <img src="[image3]" alt="Ad Image 1" width="100%">
                  [topOfMindDescription3]
                <br>
                  <br>
                <img src="[image4]" alt="Ad Image 1" width="100%">
                  [topOfMindDescription4]
                <br>
            ...
            <div class="x_827423126align-center" style="text-align: center">
                ...
                <a href="[linktoWebsite2]" target="_blank" style="color:#009899; font-size:24px;">[topOfMindPitch2]
