// src/CRMtemplates/repeatContactTemplate.js

export const repeatContactTemplate = `
<div>
        ...
        <div style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10pt">
            ...
            <div class="x_827423126align-center" style="text-align: center">
                <a href="[linktoWebsite]"
                   ...
                   target="_blank">[repeatContactPitch1]</a>
            </div>
            <div>
                <br>
                <img src="[image1]" alt="Ad Image 1" width="100%">
                  [repeatContactDescription1]
                <br>
                <br>
                <img src="[image2]" alt="Ad Image 2" width="100%">
                 [repeatContactDescription2]
                 <br>
                 <br>
                      <img src="[image3]" alt="Ad Image 2" width="100%">
                 [repeatContactDescription3]

            </div>

            <div class="x_827423126align-center" style="text-align: center">
          
                  <a href="[linktoWebsite2]" target="_blank" style="color:#009899; font-size:24px;">[repeatContactPitch]
