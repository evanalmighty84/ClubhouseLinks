// src/CRMtemplates/thankYouForYourBusinessTemplate.js

export const thankYouForYourBusinessTemplate = `
<div>
        ...
        <div style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10pt">
            ...
            <div class="x_827423126align-center" style="text-align: center">
                <a href="[linktoWebsite]"
                   ...
                   target="_blank">[thankYouForYourBusinessPitch1] </a>
            </div>
            <div>
                <br>
                <img src="[image1]" alt="Ad Image 1" width="100%">
                  [thankYouForYourBusinessDescription1]
                <br>
            ...
            <div class="x_827423126align-center" style="text-align: center">
                ...
                <a href="[linktoWebsite2]" target="_blank" style="color:#009899; font-size:24px;">[thankYouForYourBusinessPitch2]
                 <img src="[image2]" alt="Podcast Ad" width="100%">
                </a>
            </div>
        </div>
    </div>
