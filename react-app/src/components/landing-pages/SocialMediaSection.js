...
const SocialMediaSection = () => {
    ...
    return (
        <section id="SocialMedia" style={{ backgroundColor: '#fff', padding: '20px 0' }}>
                    ...
                    >
                        ...
                        {showLogo && (
                            <h2
                                ...
                                data-aos-delay="200"
                            >
                                Our SocialMedia Platform
                            </h2>
                        )}
                    </div>
                </div>

                <h2 className="text-center mb-5" style={{color:'black'}}>How Our SocialMedia Works</h2>

                <div className="row">
                    {SocialMediaData.map((item, i) => (
                        <div className="col-md-6 mb-4" key={i}>
                            <div
                                className="media SocialMedia-thumb flex-column align-items-center"
                                data-aos="fade-up"
